...
namespace MiBarberiaApp.Controllers
{
    public class ServicioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Duracion,Precio,Descripcion")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Duracion,Precio,Descripcion")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
